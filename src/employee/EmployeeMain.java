...
public class EmployeeMain {
		...
		public static void main(String[] args) throws SQLException {
	        ...
	        while (!exit) {
	            ...
	            switch (option) {
	                case 1:
	                    System.out.println("Number of rows affected : " + SQlOperation.insert());
	                    break;
	                case 2:
	                    SQlOperation.show();
	                    break;
	                case 3:
	                    System.out.println("Number of rows affected : " + SQlOperation.update());
	                    break;
	                case 4:
	                    System.out.println("Number of rows affected : " + SQlOperation.delete());
	                    break;
	                case 5:
	                    exit = true;
